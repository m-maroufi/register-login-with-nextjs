...
export default function Home() {
  return (
    <>
      <div className="bg-catskill-white overflow-hidden min-h-screen relative pb-40 mobile-form md:hidden">
        <Image
      ...
      <div className="desktop-form bg-catskill-white overflow-hidden h-[calc(100vh-24px)] relative hidden md:flex lg:container mx-auto py-6 px-4">
